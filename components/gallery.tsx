...
export default function Gallery() {
  ...
  const galleryImages = [
    {
      src: "https://res.cloudinary.com/dx8w9qwl6/image/upload/v1762857992/adiwrna60-1_mojvnf.avif",
      alt: "Modern luxury home exterior",
      type: "image",
    },
    {
      src: "https://res.cloudinary.com/dx8w9qwl6/image/upload/v1762849944/adiwerna40-2_mjcxeo.avif",
      alt: "Modern luxury home pool",
      type: "image",
    },
    {
      src: "https://www.instagram.com/reel/DKV9jmwzvYE/?igsh=OG95a29mczhqM20w",
      alt: "Instagram Reel 1",
      type: "video",
      thumbnail: "https://res.cloudinary.com/dx8w9qwl6/image/upload/v1762849944/adiwerna40-2_mjcxeo.avif",
    },
    {
      src: "https://res.cloudinary.com/dx8w9qwl6/image/upload/v1762850671/adiwerna55-2_prfhts.avif",
      alt: "Instagram Reel 2",
      type: "image",
      thumbnail: "https://res.cloudinary.com/dx8w9qwl6/image/upload/v1762850671/adiwerna55-2_prfhts.avif",
    },
  ...
  return (
    <section id="gallery" className="section">
      <div className="container">
        <h2 className="section-title">Gallery Sapphire Serenity Adiwerna</h2>
        <p className="section-subtitle">
          Temukan keindahan dan kenyamanan rumah impian Anda di Sapphire Serenity Adiwerna. Setiap sudut dirancang dengan
